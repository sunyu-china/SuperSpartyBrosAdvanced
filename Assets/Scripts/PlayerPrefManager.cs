...
public static class PlayerPrefManager {
	...
	public static void SavePlayerState(int score, int highScore, int lives, int maxHealth) {
	...
	public static void ResetPlayerState(int startLives, int startHealth, bool resetHighscore) {
	...
	public static void ShowPlayerPrefs() {
		...
		string[] values = {"Score","Highscore","Lives","MaxHealth"};
